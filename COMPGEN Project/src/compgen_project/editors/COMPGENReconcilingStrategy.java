...
public class COMPGENReconcilingStrategy implements IReconcilingStrategy, IReconcilingStrategyExtension {
	 ...
	 */
	public COMPGENEditor getEditor() {
		return editor;
	}

	public void setEditor(COMPGENEditor editor) {
		this.editor = editor;
	}
